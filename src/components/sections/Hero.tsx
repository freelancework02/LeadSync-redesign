...
export default function Hero() {
    ...
    return (
        <section ref={containerRef} className="relative min-h-screen flex items-center pt-32 pb-20 overflow-hidden bg-white border-b border-slate-200">
            {/* Background Elements */}
            <div className="absolute inset-0 -z-10 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20 pointer-events-none" />
            <div className="absolute top-0 right-0 w-[50%] h-[50%] bg-gradient-to-bl from-blue-100/50 to-transparent blur-3xl pointer-events-none" />
            <div className="absolute bottom-0 left-0 w-[40%] h-[40%] bg-gradient-to-tr from-sky-100/50 to-transparent blur-3xl pointer-events-none" />

            <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">

                {/* Left Content */}
                <div className="max-w-2xl relative z-10">
                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-100/80 text-blue-700 rounded-full text-xs font-bold uppercase tracking-wider mb-6 backdrop-blur-sm border border-blue-200">
                    ...
                    <h1 ref={titleRef} className="text-5xl lg:text-7xl font-bold tracking-tight mb-6 leading-[1.1] font-clash text-black">
                    ...
                    <p ref={subtitleRef} className="text-xl text-slate-600 mb-8 max-w-lg leading-relaxed">
                    ...
                    <div ref={ctaRef} className="flex flex-col sm:flex-row gap-4">
                        ...
                        <button className="flex items-center gap-3 px-8 py-4 rounded-full font-bold text-lg border border-slate-200 hover:bg-slate-50 text-slate-700 transition-colors bg-white/50 backdrop-blur-sm">
                ...
                <div ref={visualRef} className="relative w-full perspective-1000">
                    <div className="relative rounded-xl overflow-hidden shadow-2xl border border-slate-200/50 bg-white ring-1 ring-slate-900/5 rotate-y-6 rotate-x-6 hover:rotate-y-0 hover:rotate-x-0 transition-transform duration-700 ease-out-expo group">
                        {/* Browser Header */}
                        <div className="bg-slate-50 px-4 py-3 border-b border-slate-200 flex items-center gap-3">
                            ...
                            <div className="flex-1 bg-white h-6 rounded-md border border-slate-200 flex items-center px-3 text-[10px] text-slate-400 font-mono">
                                leadsync360.com/dashboard
                            </div>
                        </div>

                        {/* Main Image */}
                        <div className="relative aspect-video bg-slate-100 overflow-hidden group-hover:scale-105 transition-transform duration-700 cursor-pointer">
                        ...
                        <div className="absolute -bottom-10 -left-10 bg-white/90 backdrop-blur-xl p-4 rounded-xl shadow-xl border border-slate-200 animate-float">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold font-clash text-black">+ 24.8%</p>
                                </div>
                            </div>
                        </div>
                    </div>
